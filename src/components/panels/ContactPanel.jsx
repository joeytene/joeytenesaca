    ...
    <div className="text-center max-w-xl mx-auto py-8">
      ...
      <div className="mt-8 flex gap-3 justify-center">
        {[
          ...
          <a
            key={i}
            className="inline-flex items-center gap-2 px-4 py-2 rounded-none bg-cream-100 border border-ink-900 hover:shadow-hard-sm hover:-translate-y-0.5 transition text-sm text-ink-900 cursor-pointer"
          >
            {s.i}
            {s.l}
          </a>
